...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-firebase/node_modules/firebase/externs/firebase-messaging-externs.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-firebase/node_modules/firebase/externs/firebase-messaging-externs.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-firebase/node_modules/firebase/externs/</a> &#187; firebase-messaging-externs.js</div>
</div>
<div class="body">
 ...
 */
firebase.messaging = <span class="fstat-no" title="function not covered" >function(app) {</span>};
&nbsp;
/**
 * Gets the {@link firebase.messaging.Messaging `Messaging`} service for the
 * current app.
 ...
 * @return {!firebase.messaging.Messaging}
 */
<span class="cstat-no" title="statement not covered" >firebase.app.App.prototype.messaging = <span class="fstat-no" title="function not covered" >function() {</span>};</span>
&nbsp;
/**
 ...
 * @interface
 */
<span class="cstat-no" title="statement not covered" >firebase.messaging.Messaging = <span class="fstat-no" title="function not covered" >function() {</span>};</span>
&nbsp;
/**
 ...
 */
<span class="cstat-no" title="statement not covered" >firebase.messaging.Messaging.prototype.requestPermission = <span class="fstat-no" title="function not covered" >function() {</span>};</span>
&nbsp;
/**
 ...
 */
<span class="cstat-no" title="statement not covered" >firebase.messaging.Messaging.prototype.getToken = <span class="fstat-no" title="function not covered" >function() {</span>};</span>
&nbsp;
/**
 ...
 */
<span class="cstat-no" title="statement not covered" >firebase.messaging.Messaging.prototype.onTokenRefresh =</span>
<span class="fstat-no" title="function not covered" >  function(nextOrObserver) {</span>};
&nbsp;
/**
 ...
 */
<span class="cstat-no" title="statement not covered" >firebase.messaging.Messaging.prototype.onMessage =</span>
<span class="fstat-no" title="function not covered" >  function(nextOrObserver) {</span>};
&nbsp;
/**
 ...
 */
<span class="cstat-no" title="statement not covered" >firebase.messaging.Messaging.prototype.deleteToken = <span class="fstat-no" title="function not covered" >function(token) {</span>};</span>
&nbsp;
/**
 ...
 */
<span class="cstat-no" title="statement not covered" >firebase.messaging.Messaging.prototype.useServiceWorker =</span>
<span class="fstat-no" title="function not covered" >  function(registration) {</span>};
&nbsp;
/**
 ...
 */
<span class="cstat-no" title="statement not covered" >firebase.messaging.Messaging.prototype.setBackgroundMessageHandler =</span>
