...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-firebase/node_modules/firebase/externs/firebase-app-externs.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-firebase/node_modules/firebase/externs/firebase-app-externs.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-firebase/node_modules/firebase/externs/</a> &#187; firebase-app-externs.js</div>
</div>
<div class="body">
 ...
 */
firebase.initializeApp = <span class="fstat-no" title="function not covered" >function(options, name) {</span>};
&nbsp;
/**
 ...
 */
firebase.app = <span class="fstat-no" title="function not covered" >function(name) {</span>};
&nbsp;
/**
 ...
 * @interface
 */
firebase.app.App = <span class="fstat-no" title="function not covered" >function() {</span>};
&nbsp;
/**
 ...
 *   been deleted.
 */
firebase.app.App.prototype.delete = <span class="fstat-no" title="function not covered" >function() {</span>};
&nbsp;
/**
 ...
 * @interface
 */
firebase.Thenable = <span class="fstat-no" title="function not covered" >function() {</span>};
&nbsp;
/**
 ...
 */
firebase.Thenable.prototype.then = <span class="fstat-no" title="function not covered" >function(onResolve, onReject) {</span>};
&nbsp;
/**
 ...
 * @return {!firebase.Thenable&lt;*&gt;}
 */
firebase.Thenable.prototype.catch = <span class="fstat-no" title="function not covered" >function(onReject) {</span>};
&nbsp;
/**
 ...
 */
firebase.Promise = <span class="fstat-no" title="function not covered" >function(resolver) {</span>};
&nbsp;
/**
 ...
 */
firebase.Promise.prototype.then = <span class="fstat-no" title="function not covered" >function(onResolve, onReject) {</span>};
&nbsp;
/**
 ...
 *   (with an error).
 */
firebase.Promise.prototype.catch = <span class="fstat-no" title="function not covered" >function(onReject) {</span>};
&nbsp;
/**
 ...
 */
firebase.Promise.resolve = <span class="fstat-no" title="function not covered" >function(value) {</span>};
&nbsp;
/**
 ...
 * @return {!firebase.Promise&lt;*&gt;}
 */
firebase.Promise.reject = <span class="fstat-no" title="function not covered" >function(error) {</span>};
&nbsp;
/**
 ...
 */
firebase.Promise.all = <span class="fstat-no" title="function not covered" >function(values) {</span>};
&nbsp;</pre></td></tr>
</table></pre>
</div>
<div class="footer">
